sap.ui.define([
    ...
    return Controller.extend("masterindirectos.controller.BaseController", {
        ...
        onCreateMonthsTable: function (oEvent) {
            ...
            // PUNTO 4 — usa il helper (true = vive insieme ai mesi)
            if (bShowEjecutado) {
                ...
                var oTitleControl = (i === iStartIdx)
                    ? new sap.m.HBox({
                        ...
                        items: [
                            ...
                            }).data("year", String(sYear)).addStyleClass("iconOnlyBtn")
                        ]
